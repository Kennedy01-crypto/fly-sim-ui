    ...
    <div className="max-w-6xl mx-auto px-6 py-4">
      <div className="flex gap-4">
        ...
        <div className="flex-1">
          <div className="flex items-center gap-2 p-4 rounded-lg border border-border bg-surface-container hover:bg-surface-container-hover cursor-pointer">
        ...
        {/* Cheapest Option */}
        <div className="flex-1">
          <div className="flex items-center justify-between p-4 rounded-lg bg-primary/10 border border-primary/20 hover:bg-primary/15 cursor-pointer">
